...
- Name: 09-negative.spec.ts >> Cenários Negativos — Validação e Rejeição >> TC-083 [-] Criar membro sem campos obrigatórios é bloqueado
- Location: tests\e2e\09-negative.spec.ts:59:7
