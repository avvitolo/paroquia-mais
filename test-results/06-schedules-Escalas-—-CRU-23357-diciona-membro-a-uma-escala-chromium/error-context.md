...
- Name: 06-schedules.spec.ts >> Escalas — CRUD e Atribuições >> TC-051 [+] Admin adiciona membro a uma escala
- Location: tests\e2e\06-schedules.spec.ts:27:7
...
Call log:
  - waiting for getByRole('link', { name: /ver|abrir|detalhes/i }).first()
