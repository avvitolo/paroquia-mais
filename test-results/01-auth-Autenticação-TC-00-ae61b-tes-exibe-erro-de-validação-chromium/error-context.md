...
- Name: 01-auth.spec.ts >> Autenticação >> TC-008 [-] Cadastro com senhas diferentes exibe erro de validação
- Location: tests\e2e\01-auth.spec.ts:73:7
      ...
      - generic [ref=e7]:
        ...
        - generic [ref=e11]:
          ...
          - generic [ref=e15]:
            ...
            - textbox "E-mail" [active] [ref=e17]:
              - /placeholder: seu@email.com
              - text: novo@paroquia-test.dev
          - generic [ref=e18]:
