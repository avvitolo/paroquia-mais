...
- Name: 02-rbac.spec.ts >> RBAC — Controle de Acesso por Papel >> TC-011 [+] coordenador vê menu sem Pastorais e Configurações
- Location: tests\e2e\02-rbac.spec.ts:23:7
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e12]:
      - generic [ref=e13]:
        - generic [ref=e14]:
          - heading "Olá, Coord!" [level=1] [ref=e15]
