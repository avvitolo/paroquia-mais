...
- Name: 05-celebrations.spec.ts >> Celebrações — CRUD e Aprovação >> TC-042 [+] Admin aprova celebração pendente do coordenador
- Location: tests\e2e\05-celebrations.spec.ts:44:7
...
Call log:
  - waiting for getByText('Retiro da Pastoral').locator('..').getByRole('button', { name: /aprovar/i })
