...
- Name: 09-negative.spec.ts >> Cenários Negativos — Validação e Rejeição >> TC-082 [-] Login com email inexistente exibe mensagem de erro
- Location: tests\e2e\09-negative.spec.ts:49:7
...
Locator: getByText(/credenciais|não encontrad|inválid/i)
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByText(/credenciais|não encontrad|inválid/i)
      ...
      - generic [ref=e7]:
        - generic [ref=e8]:
          ...
          - textbox "E-mail" [ref=e10]:
            ...
            - text: naoexiste_xyz987@paroquia.test
        - generic [ref=e11]:
          - generic [ref=e12]:
            - generic [ref=e13]: Senha
            - link "Esqueceu a senha?" [ref=e14] [cursor=pointer]:
              - /url: /forgot-password
          - textbox "Senha" [ref=e15]:
            - /placeholder: ••••••••
            - text: qualquerSenha123
        - button "Entrar" [ref=e16]
      - paragraph [ref=e17]:
        - text: Não tem conta?
        - link "Cadastrar paróquia" [ref=e18] [cursor=pointer]:
          - /url: /signup
