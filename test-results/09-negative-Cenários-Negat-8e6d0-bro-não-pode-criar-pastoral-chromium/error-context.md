...
- Name: 09-negative.spec.ts >> Cenários Negativos — Validação e Rejeição >> TC-085 [-] Membro não pode criar pastoral
- Location: tests\e2e\09-negative.spec.ts:89:7
...
Locator:  getByRole('button', { name: /nova pastoral|adicionar/i })
