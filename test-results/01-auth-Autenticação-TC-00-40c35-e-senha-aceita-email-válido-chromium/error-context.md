...
- Name: 01-auth.spec.ts >> Autenticação >> TC-009 [+] Página de recuperação de senha aceita email válido
- Location: tests\e2e\01-auth.spec.ts:85:7
  ...
  - main [ref=e2]:
    - generic [ref=e3]:
      - generic [ref=e4]:
        ...
        - paragraph [ref=e6]: Recuperar senha
      - paragraph [ref=e7]: Digite seu e-mail e enviaremos um link para redefinir sua senha.
      - generic [ref=e8]:
        - generic [ref=e9]:
          - generic [ref=e10]: E-mail
          - textbox "E-mail" [ref=e11]:
            - /placeholder: seu@email.com
            - text: qualquer@email.com
        - button "Enviar link de recuperação" [ref=e12]
      - paragraph [ref=e13]:
        - text: Lembrou a senha?
        - link "Voltar ao login" [ref=e14] [cursor=pointer]:
          - /url: /login
