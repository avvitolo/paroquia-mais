...
- Name: 10-edge-cases.spec.ts >> Edge Cases — Entradas Extremas e Limites >> TC-103 [edge] Pastoral com nome de 200 caracteres é tratada sem crash
- Location: tests\e2e\10-edge-cases.spec.ts:62:7
  ...
  - generic [ref=e2]:
    ...
    - main [ref=e12]:
      - generic [ref=e14]:
        ...
        - generic [ref=e19]:
          - heading "Nova Pastoral" [level=2] [ref=e20]
          - generic [ref=e21]:
            - generic [ref=e22]: Nome *
            - textbox "Nome *" [disabled]:
              - /placeholder: "Ex: Pastoral da Juventude"
              - text: PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP
          - generic [ref=e23]:
            - generic [ref=e24]: Descrição
            - textbox "Descrição" [disabled]:
              - /placeholder: Breve descrição da pastoral
          - generic [ref=e25]:
            - button "Salvando..." [disabled]
            - button "Cancelar" [disabled]
        - generic [ref=e28]:
          - generic [ref=e29]:
            - heading "Pastoral da Liturgia" [level=3] [ref=e30]
            - paragraph [ref=e31]: 0 função(ões) cadastrada(s)
          - generic [ref=e32]:
            - button "Funções" [ref=e33]
            - button "Editar" [ref=e34]
            - button "Excluir" [ref=e35]
