...
- Name: 05-celebrations.spec.ts >> Celebrações — CRUD e Aprovação >> TC-045 [+] Admin edita celebração existente
- Location: tests\e2e\05-celebrations.spec.ts:77:7
...
Call log:
  - waiting for getByText('Missa de Domingo').locator('..').getByRole('button', { name: /editar/i })
