...
- Name: 03-pastorals.spec.ts >> Pastorais — CRUD >> TC-021 [+] Admin cria nova pastoral com sucesso
- Location: tests\e2e\03-pastorals.spec.ts:22:7
...
Locator: getByText('Pastoral da Catequese')
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByText('Pastoral da Catequese')
