...
- Name: 06-schedules.spec.ts >> Escalas — CRUD e Atribuições >> TC-050 [+] Admin cria escala vinculada a uma celebração
- Location: tests\e2e\06-schedules.spec.ts:10:7
  ...
  - generic [ref=e2]:
    ...
    - main [ref=e12]:
      - generic [ref=e14]:
        ...
        - generic [ref=e23]:
          - heading "Nova Escala" [level=2] [ref=e24]
          - paragraph [ref=e25]:
            - text: Não há celebrações cadastradas.
            - link "Cadastre uma celebração" [ref=e26] [cursor=pointer]:
              - /url: /celebrations
            - text: primeiro.
