...
- Name: 05-celebrations.spec.ts >> Celebrações — CRUD e Aprovação >> TC-040 [+] Admin cria celebração aprovada diretamente
- Location: tests\e2e\05-celebrations.spec.ts:11:7
