...
- Name: 10-edge-cases.spec.ts >> Edge Cases — Entradas Extremas e Limites >> TC-105 [edge] Múltiplas pastorais criadas sequencialmente sem erro
- Location: tests\e2e\10-edge-cases.spec.ts:91:7
...
Locator: getByText('Pastoral Alpha')
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByText('Pastoral Alpha')
      ...
      - generic [ref=e14]:
        ...
        - generic [ref=e19]:
          ...
          - generic [ref=e21]:
            ...
            - textbox "Nome *" [ref=e23]:
              - /placeholder: "Ex: Pastoral da Juventude"
          - generic [ref=e24]:
            - generic [ref=e25]: Descrição
            - textbox "Descrição" [ref=e26]:
              - /placeholder: Breve descrição da pastoral
          - generic [ref=e27]:
            - button "Criar Pastoral" [ref=e28]
            - button "Cancelar" [ref=e29]
        - generic [ref=e32]:
          - generic [ref=e33]:
            - heading "Pastoral da Liturgia" [level=3] [ref=e34]
            - paragraph [ref=e35]: 0 função(ões) cadastrada(s)
          - generic [ref=e36]:
            - button "Funções" [ref=e37]
            - button "Editar" [ref=e38]
            - button "Excluir" [ref=e39]
