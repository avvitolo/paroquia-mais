...
- Name: 10-edge-cases.spec.ts >> Edge Cases — Entradas Extremas e Limites >> TC-106 [edge] Título de celebração com emojis não quebra a UI
- Location: tests\e2e\10-edge-cases.spec.ts:110:7
