...
- Name: 04-members.spec.ts >> Membros — CRUD >> TC-033 [+] Admin edita dados de um membro existente
- Location: tests\e2e\04-members.spec.ts:43:7
...
Call log:
  - waiting for getByText('João Acólito').locator('..').getByRole('button', { name: /editar/i })
