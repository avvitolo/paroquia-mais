...
- Name: 05-celebrations.spec.ts >> Celebrações — CRUD e Aprovação >> TC-041 [+] Coordenador cria celebração com status pendente
- Location: tests\e2e\05-celebrations.spec.ts:27:7
