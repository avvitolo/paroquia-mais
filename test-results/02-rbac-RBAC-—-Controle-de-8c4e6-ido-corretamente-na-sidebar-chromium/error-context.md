...
- Name: 02-rbac.spec.ts >> RBAC — Controle de Acesso por Papel >> TC-016 [+] badge de role exibido corretamente na sidebar
- Location: tests\e2e\02-rbac.spec.ts:74:7
...
Locator: locator('aside').getByText('Admin Sistema')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('aside').getByText('Admin Sistema')
