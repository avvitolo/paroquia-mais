...
- Name: 05-celebrations.spec.ts >> Celebrações — CRUD e Aprovação >> TC-046 [+] Admin exclui celebração sem associação
- Location: tests\e2e\05-celebrations.spec.ts:89:7
